...
insert into FUNCIONARIOS(ID, nome, cpf) value ('186781778020', 'Marcos Albert', '47965864401');
insert into FUNCIONARIOS(ID, nome, cpf) value ('042781182100', 'Sirilo Ramos', '37956329949');
...
insert into FUNCION_TERCERIZADOS(ID, salario, empresa, serviço) value ('186781778020', 'R$:1800,00', 'MaisBanho', 'Banho');
insert into FUNCION_TERCERIZADOS(ID, salario, empresa, serviço) value ('042781182100', 'R$:1800,00', 'MaisTosa', 'Tosa');
...
insert into ESPECIALIZAÇOES(cpf, experiencia, formaçao) value ('47965864401', '6 anos', 'Técnico');
insert into ESPECIALIZAÇOES(cpf, experiencia, formaçao) value ('37956329949', '5 anos', 'Técnico');
...
insert into ESP_BANHO_TOSA(cpf, Hr_atendimento, nome, idade) value ('47965864401', '07:00-17:00', 'Marcos Albert', 34);
insert into ESP_BANHO_TOSA(cpf, Hr_atendimento, nome, idade) value ('37956329949', '07:00-17:00', 'Sirilo Ramos', 35);
...
insert into SERVIÇO_FORNECIDO(ID, tipo_serviço) value ('186781778020', 'Banho');
insert into SERVIÇO_FORNECIDO(ID, tipo_serviço) value ('042781182100', 'Tosa');
...
insert into ESPECIALIZAÇAO_POSSUIDA(ID, cpf) value ('186781778020', '47965864401');
insert into ESPECIALIZAÇAO_POSSUIDA(ID, cpf) value ('042781182100', '37956329949');
